...
4.  Regn om til Kelvin:  $65 ^\circ C, 363^\circ C, -56^\circ C, 353^\circ C $\\\\
5. Regn om til celisus: 273,15K, 333K, 97K, 830K\\\\
6. En gass innestengt i beholder har et trykk på $P_1=6,3bar$.  hvor stort blir trykket når vi halverer volumet og temperaturen er konstant? $V_1=7L$\\\\
...
I starten er volumet $V_1=12L$ og trykket er lik $P_1=2,1bar$ .  Vi endrer volumet mens temperaturen er konstant slik at volumet blir $V_2=3L$.  Hva blir det nye trykket $P_2?$ \\\\
...
\noindent 9. Vi kan se på en firkantet kloss som ligger på et bord:\\\\\\\
\begin{center}
