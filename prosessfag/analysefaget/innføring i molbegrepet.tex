...
\begin{table}[h!]
    ...
    \end{tabular}
\end{table}
Dette betyr at 1 mol C reagerer med e1 mol $O_2$ og vi får laget 1 mol $CO_2$. Vi må først finne ut hvor mange mol C vi har.  Hint: 1245kg=1245000000g\\\\
...
\end{table}\newpage
  \noindent  \textbf{3 Bestemme begrensende reaktant:}\\\\
    En artig reaksjon er forbrenning av hydrogen ($H_2)$.  Det er den som skjer i en hydrofgenbil:\\\\
$$2H_2(g)+O_2(g)=2H_2O(g)+ el. energi$$\\
Vi lar 234g $H_2$ reagere med 850g $O_2$.  Hvor mye vann får vi laget?\\\\
Her må først beregne antall mol av hvert stoff:\\\\\\
