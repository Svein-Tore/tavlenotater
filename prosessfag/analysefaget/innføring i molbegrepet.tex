...
\begin{table}[h!]
    ...
    \end{tabular}
\end{table}\\
Her ser vi at 234g $H_2$, som tilsvarer 115,842mol reagerer med 57,921 mol $O_2$, som er havlparten av 115,842mol (vi ser jo fra reaksjonen at det skal være halvparten så mange mol av $O_2$). Men vi har jo bare  26,563mol $O_2$.  Og det er jo klart for lite.  Hva vil skje?  Her sier vi at $O_2$ er begrensende faktor.  Det vil si at alt av $O_2$ reagerer. Men vi vil få en rest av $H_2$ på $115,842mol-26,563mol\cdot 2=62,716mol$ som ikke vil reagere.  Og mengden $H_2$ som regaerer er det dobb elte agva mengde n $O_2$ som er $2\cdot 26,563mol=53,126mol$ Oppsummert:\\\\
\begin{table}[h!]
    \centering
    \begin{tabular}{cccccc}
         R.x.:&  $2H_2(g)$&  +&  $O_2(g)$&  =& $2H_2O(g)$\\
         molforhold:&$2\cdot 26,563$&  & $26,563$&  &$2\cdot 26,563$\\
         molforhold:&53,126mol& &26,563mol&&53,126mol\\
         masse:&107,315gg&+&850g=957,315&=&957,330g\\\\ 
         rest $H_2$:&$234g-107,315g=126,685g$& \\
    \end{tabular}
\end{table}\\
\textbf{Eksempel med produksjon av ammoniakk:} \\
For produksjon av ammoniak gjlder følgende kjemiske reaksjon:++
$$3H_2(g)+N_2(g)=2NH_3(g)$$\\
Spm: Hvor mye hydrogen og nitrogen trengs for å produsere 100g ammoniakk?\newpage
\begin{table}[h!]
    \centering
    \begin{tabular}{cccccc}
         R.x.:&  $3H_2(g)$&  +&  $N_2(g)$&  =& $2NH_(g)$\\
         molforhold:&$3$&  & $1$&  &$2$\\
         molforhold:&3 & &2&&2\\
         masse:&?&+=&?&=&?\\\\ 
    \end{tabular}
